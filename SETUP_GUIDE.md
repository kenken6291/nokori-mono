...
| Purchases | 材料費の購入記録（email, ingredientName, price, purchasedAt） | `1sD-XMbowTdyOG0FLb_WcCZS34CIk-QN0xYbSVPzcddM` |
...
| 材料費の記録（今週の合計・食材ごとの内訳） | `js/costs.js` purchaseForm → `gas/Code.gs` handleAddPurchase / handleMyPurchases |
